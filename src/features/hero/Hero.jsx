...
import { ArrowRight, Download, Github, Linkedin, Mail, MapPin, Code2, Terminal, UserCheck } from "lucide-react";
...
function Typewriter() {
  ...
  return (
    <span className="text-[#E8B84B] font-semibold">
      {text}
      <span className="inline-block w-[2px] h-[0.8em] bg-[#E8B84B] ml-1 animate-pulse align-middle" />
    </span>
  );
}
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-left">
            ...
            >
              <Button
                asChild
                size="lg"
                className="bg-[#E8B84B] hover:bg-[#D4A338] text-[#0E2A2B] border-0 rounded-md text-xs sm:text-sm font-bold px-6 shadow-subtle transition-colors"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="rounded-md border-[#1C4E50] bg-[#133637] hover:bg-[#184143] text-[#F4EFE6] text-xs sm:text-sm font-medium px-5 transition-colors"
              >
                <a
                ...
                >
                  <Download className="w-4 h-4 text-[#E8B84B]" /> Download Resume
                </a>
              </Button>
            </motion.div>
              ...
              <div className="flex gap-2">
                {[
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-9 h-9 grid place-items-center rounded-md border border-[#1C4E50] bg-[#133637] text-[#A1B5B3] hover:text-[#E8B84B] hover:border-[#E8B84B]/50 transition-all shadow-subtle"
                  >
            ...
            <div className="relative rounded-md border border-[#1C4E50] bg-[#133637] p-6 shadow-card space-y-5">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3 rounded-md bg-[#0E2A2B] border border-[#1C4E50] space-y-1">
                  ...
                  <p className="text-[#A1B5B3] text-[11px] leading-relaxed">
